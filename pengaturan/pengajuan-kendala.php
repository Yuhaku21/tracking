...
<body>
    ...
    <div class="app">
        ...
        <div class="content">
            <!--HeroSection-->
            <div class="welcome">
                <h2 id="username">Pengajuan Kendala</h2>
            </div>
            ...
            <!--MainContent-->
            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Tulis Pengajuan Kendala</label>
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="Tulis pesan disini..."></textarea>
            </div>
